...
const queueDefinitions: QueueDefinition[] = [
  ...
  {
    name: WebhookDispatchJob.QUEUE_NAME,
    processor: WebhookDispatchJob.process,
    options: {
      defaultJobOptions: {
        attempts: 3,
  ...
  {
    name: DeadLetterJob.QUEUE_NAME,
    processor: DeadLetterJob.process,
    options: {
      defaultJobOptions: {
        attempts: 1,
